...
export function BackgroundCustomizer() {
  ...
  const applyBackground = useCallback(() => {
    ...
    root.style.setProperty('--text-primary', hexToHsl(settings.textPrimary))
    root.style.setProperty('--text-secondary', hexToHsl(settings.textSecondary))
    root.style.setProperty('--text-muted', hexToHsl(settings.textMuted))
